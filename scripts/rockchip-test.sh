...
#=================================================
echo '修改主机名'
sed -i "s/hostname='OpenWrt'/hostname='RockChip'/g" ./package/base-files/files/bin/config_generate
echo '修改dts'
rm -rf target/linux/rockchip/files/arch/arm64/boot/dts/rockchip/rk3588-armsom-sige7.dts
cp -f $GITHUB_WORKSPACE/configs/imb3588.dts target/linux/rockchip/files/arch/arm64/boot/dts/rockchip/rk3588-armsom-sige7.dts
